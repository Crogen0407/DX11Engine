...
{
	vector<VertexTextureData> vertex;
	vertex.resize(4);
...
void GeometryHelper::CreateCube(shared_ptr<Geometry<VertexTextureData>> geometry)
{
	...
	// æ’∏È
	vtx[0x0] = VertexTextureData( Vec3(-w2, -h2, -d2), Vec2(0.0f, 1.0f) );
	vtx[0x1] = VertexTextureData( Vec3(-w2, +h2, -d2), Vec2(0.0f, 0.0f) );
	vtx[0x2] = VertexTextureData( Vec3(+w2, +h2, -d2), Vec2(1.0f, 0.0f) );
	vtx[0x3] = VertexTextureData( Vec3(+w2, -h2, -d2), Vec2(1.0f, 1.0f) );

	// µﬁ∏È
	vtx[0x4] = VertexTextureData( Vec3(-w2, -h2, +d2), Vec2(1.0f, 1.0f) );
	vtx[0x5] = VertexTextureData( Vec3(+w2, -h2, +d2), Vec2(0.0f, 1.0f) );
	vtx[0x6] = VertexTextureData( Vec3(+w2, +h2, +d2), Vec2(0.0f, 0.0f) );
	vtx[0x7] = VertexTextureData( Vec3(-w2, +h2, +d2), Vec2(1.0f, 0.0f) );

	// ¿≠∏È
	vtx[0x8] = VertexTextureData( Vec3(-w2, +h2, -d2), Vec2(0.0f, 1.0f) );
	vtx[0x9] = VertexTextureData( Vec3(-w2, +h2, +d2), Vec2(0.0f, 0.0f) );
...
void GeometryHelper::CreateGrid(shared_ptr<Geometry<VertexTextureData>> geometry, UINT sizeX, UINT sizeZ)
{
	vector<VertexTextureData> vtx;
...
void GeometryHelper::CreateGrid(shared_ptr<Geometry<VertexTextureNormalData>> geometry, UINT sizeX, UINT sizeZ)
{
	vector<VertexTextureNormalData> vtx;
